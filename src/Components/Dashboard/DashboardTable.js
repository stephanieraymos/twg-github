                    ...
                    .map((row, index) => {
                      ...
                      return (
                        <TableRow
                          hover
                          onClick={(event) =>
                            handleClick(event, row.id, row.email == null)
                          }
                          key={row.id}
                        >
                            ...
                            if (item.id === "shippingStatus") {
                              if (row["sold"] != null)
                                return (
                                  ...
                                  <TableCell
                                    key={`custom-table-cell-${cellIndex}`}
                                    align="right"
                                  >
                                    <Chip
                                      label={getShippingStatus(row[item.id])}
                                      style={{
                              ...
                              return (
                                ...
                                >
                                  <Chip
                                    label={row[item.id] ? "Paid" : "Unpaid"}
                                    style={{
                                      backgroundColor: row[item.id]
                                        ? "#4caf50"
                                        : "#f44336",
                                      color: "white",
                                    }}
                              ...
                              return (
                                <TableCell
                                  ...
                                  align="right"
                                >
                                  ${numberWithCommas(row[item.id], true)}
                                </TableCell>
                              );
                              ...
                              return (
                                ...
                                } ${date.getDate()}, ${date.getFullYear()}`}</TableCell>
                              );
                            } else
                              return (
                                <TableCell
