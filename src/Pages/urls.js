...
if (development) {
  ...
  inventoryV2GetByIdURL =
    "https://api.thewholesalegroup.com/test/v2/inventory/?id=";
  inventoryV2GetBySellerIdURL =
    "https://api.thewholesalegroup.com/test/v2/inventory/?sellerId=";
  inventoryV2GetByBuyerIdURL =
    "https://api.thewholesalegroup.com/test/v2/inventory/?buyerId=";
  inventoryV2URL = "https://api.thewholesalegroup.com/test/v2/inventory/edit/";
  inventoryV2FilesURL =
    "https://api.thewholesalegroup.com/test/v2/inventory/files/";
}
