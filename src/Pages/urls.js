...
if (development) {
  ...
  tokenVerifyURL = "http://143.110.225.28/v1/account/token/verify/";
  tokenRefreshURL = "http://143.110.225.28/v1/account/token/refresh/";
  emailVerificationURL = "http://143.110.225.28/v1/account/register/verify/";

  loginURL = "http://143.110.225.28/v1/account/login/";
  logoutURL = "http://143.110.225.28/v1/account/logout/";
  registerURL = "http://143.110.225.28/v1/account/register/";

  userURL = "http://143.110.225.28/v1/account/user/";
  userUpdateURL = "http://143.110.225.28/v1/account/user/update/";
  passwordChangeURL = "http://143.110.225.28/v1/account/password/change/";

  resetPasswordEmailURL =
    "http://143.110.225.28/v1/account/password/reset/email/";
  resetPasswordURL = "http://143.110.225.28/v1/account/password/reset/";

  superuserURL = "http://143.110.225.28/v1/superuser/users/";
}
